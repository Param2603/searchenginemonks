import { Search, Phone, Mail, MapPin, ArrowUp } from "lucide-react";
    ...
    <footer className="bg-gray-900 text-gray-300" aria-label="Site footer">
      ...
      <div className="bg-gradient-to-r from-orange-500 to-orange-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a
            href="#contact"
            className="shrink-0 px-8 py-4 bg-white text-orange-600 font-bold rounded-xl hover:bg-gray-50 transition-colors shadow-lg text-base"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <a href="#" className="flex items-center gap-2 mb-5" aria-label="Search Engine Monks">
              ...
              <div className="flex flex-col leading-tight">
                ...
                <span className="text-[11px] font-semibold text-orange-400 uppercase tracking-widest -mt-0.5">
                  Monks
                </span>
              </div>
            </a>
            <p className="text-sm text-gray-400 leading-relaxed mb-6">
              A full-service digital marketing agency helping Canadian businesses
              grow through innovative websites, SEO, branding, and AI-powered
              marketing solutions.
            </p>
